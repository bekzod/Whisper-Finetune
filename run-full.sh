...
accelerate launch --multi_gpu --num_processes=2 --config_file ./configs/accelerate.yaml finetune.py \
  ...
  # --train_data ../datasets/uzbek_voice+../datasets/FeruzaSpeech:train+../datasets/FeruzaSpeech:validation+../datasets/dataset_for_stt_ttsmodels+../datasets/fleurs_uz_uz:train+../datasets/fleurs_uz_uz:dev+../datasets/uzbek_voice_2:train+../datasets/uzbek_voice_2:dev+../datasets/uzbek_voice_2:validated+../datasets/uzbek_voice_3+../datasets/uzbek_voice_4+../datasets/uzbekvoice_filtered:train \
