...
from huggingface_hub import snapshot_download  # needed for common_voice branch
...
class CustomDataset(Dataset):
    def __init__(
        ...
        assert max_sentence <= 800, (
            f"max_sentence cannot be greater than 800, current value: {max_sentence}"
        )
    ...
    def _load_huggingface_dataset(self, data_path, dataset_subset=None):
        ...
        try:
            ...
            if os.path.isdir(data_path):
                ...
                if repo == "mozilla-foundation/common_voice_17_0" and subset_name:
                    print(
